<!-- PROJECT LOGO -->
<p align="center">
  <a href="https://routerprotocol.com">
    <img src="static/logo/router-logo-light.svg" alt="Logo" width="120">
  </a>

  <h2 align="center">Router Chain Docs</h3>

  <p align="center">
    Router's documentation portal, built with Docusaurus and inspired by <a href="https://github.com/router-protocol/router-chain-docs">Osmosis' </a> configuration and template.
    <br />
    <a href="https://dev.routerprotocol.com"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://dev.routerprotocol.com">View Demo</a>
    ·
    <a href="https://github.com/router-protocol/router-chain-docs/issues">Report Bug</a>
    ·
    <a href="https://github.com/router-protocol/router-chain-docs/issues">Request Feature</a>
  </p>
</p>
...
[Docusaurus](https://docusaurus.io/) is a static site generator that helps you ship beautiful, accessible docs. For building our [documentation](https://docs.routerprotocol.com) portal, we have made certain modifications over the template generated by [Docusaurus](https://docusaurus.io). 
...
```sh
git clone https://github.com/router-protocol/router-chain-docs.git
```
...
```sh
yarn run docusaurus docs:version:flutter 1.2.3
```
...
Contributions are what make the open source community such an amazing place to be learn, inspire, and create. Any contributions you make are **greatly appreciated**. Sincere thanks to all our contributors. Thank you, [contributors](https://github.com/facebook/docusaurus/graphs/contributors)!
