...
**Step 2)** A MetaMask window will pop up following the previous step. Connect the account that we set up in the guide given <a href="./setting-up-routers-evm-testnet#part-2-importing-a-wallet-to-interact-with-the-testnet" target="_blank">here</a>.

> **Warning:** Make sure you're connected to Router's EVM Testnet.

**Step 3)** Add the gateway address for the respective chain (mentioned in the table below), click on **Deploy** and sign the transaction in your MetaMask.
