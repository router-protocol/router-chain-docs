...
<Section>
  ...
  <Card
    title="Voyager v1.0"
    description="Dissecting different functions and parameters associated with Voyager v1.0"
    to="/develop/voyager/voyager-v1.0/architecture"
    icon={<AssetIcon />}
  />
    <Card
    title="Voyager v2.0"
    description="Understanding the architecture of Voyager v2.0"
    to="/develop/voyager/voyager-v2.0/high-level-workflow"
    icon={<ModulesIcon />}
  />
  {/* <Card
    ...
    to="/develop/voyager/voyager-v1.0/different-use-cases"
    icon={<ModulesIcon />}
  />
  <Card
    title="Fee Model"
    description="Gaining a deeper understanding of how the Voyager fee is computed"
    to="/develop/voyager/voyager-v1.0/fee-model"
    icon={<AssetIcon />}
  /> */}
</Section>
...
<Section>
  <Card
    ...
    to="/develop/voyager/voyager-v1.0/guides/crosschain-staking"
    icon={<Guide />}
  />
</Section>
