...
We can return any data from this function which we might use while handling acknowledgement on the source chain Let us return abi encoded request ID and the message string from this function.
