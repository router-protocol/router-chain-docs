...
2. To process the acknowledgment of their requests on the source chain, user will have to implement a **`i_Ack`** function on their source chain contracts.
