# Decentralized Cross-chain Read Requests
...
- [Creating and Sending a Cross-chain Read Request](./evm_guides/creating-and-sending-a-cross-chain-read-request.md)
- [Handling the Acknowledgment on the Source Chain](./evm_guides/handling-the-acknowledgment-on-the-source-chain.md)
- [Sample Read Call Contract](./evm_guides/sample-read-call-contract.md)

### Near Guides

- [Creating and Sending a Cross-chain Read Request](./near_guides/creating-and-sending-a-cross-chain-read-request.md)
- [Handling the Acknowledgment on the Source Chain](./near_guides/handling-the-acknowledgment-on-the-source-chain.md)
